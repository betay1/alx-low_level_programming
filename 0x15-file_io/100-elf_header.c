 ...
 * @e_ident: A pointer containing the ELF
 */
...
/**
 * print_abi - Prints the ABI ver.
 * @e_ident: A pointer to an array containing the ELF ABI ver
 */
void print_abi(unsigned char *e_ident)
{
 ...
 *
 * Description: If the file not closed - exit code 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
